...
const repeatMyParam = () => {
  //YOUR CODE HERE
  axios.get("http://localhost:3000/repeat/parryPlay").then((res) => {
...
const quereyPlay = () => {
  axios
    .get("http://localhost:3000/query-test?/minecraftEnchantment=Fire-Aspect2")
    .then((res) => {
      console.log(res);
    });
};
document.getElementById("query-button").addEventListener("click", quereyPlay);
////////////////
//INTERMEDIATE//
////////////////
...
//It said you sent an empty querey also found in the index.js
//It gave a status 200 and showed me the different querys in the url
